        ...
        <div class="row mb-4">
            ...
            <div class="col-md-5">
                <a href="{{ route('admin.additionals.create') }}" class="btn btn-kalografi btn-icon-split">
                    ...
                    <div class="text">Add New Additional Service</div>
                </a>
            </div>
            ...
            <div class="col-md-10">
                <div class="card shadow-sm mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-kalografi">All Additional Services</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover" id="additionalsTable" aria-describedby="additionalsTable"
